  ...
  return (
    <div className="mx-48 mt-12">
      ...
      <div className="mt-6">
        ...
        <p className="text-[#686868]">
          Cleverank collects various types of information when you use our
          platform, including:
        </p>
        <ul
      ...
      <div className="mt-6">
        ...
        <p className="text-[#686868]">
          We use the personal information and data we collect for various
          purposes, including:
        </p>
        <ul
          style={{ listStyleType: "disc" }}
      ...
      <div className="mt-6">
        ...
        <p className="text-[#686868]">
          Cleverank uses cookies and similar technologies to enhance your
          experience and collect data on how you use our platform. Cookies are
          small text files stored on your device that help us remember your
          preferences, track site usage, and improve the overall functionality
          of the platform.
        </p>
      ...
      <div className="mt-6">
        ...
        <p className="text-[#686868]">
          As a data subject, you have several rights regarding your personal
          data, including:
        </p>
        <p className="mt-4">Types of Cookies We Use:</p>
        <ul
      ...
      <div className="mt-6">
        ...
        <p className="text-[#686868] mt-4">
          Please note that while we will make every effort to accommodate your
          request, there may be certain legal or operational reasons that
          prevent us from immediately deleting all data. We will inform you if
          this is the case.
        </p>
      </div>

      <div className="mt-6">
        <h1 className=" text-2xl  font-semibold  mb-4">7. Data Security</h1>
        <p className="text-[#686868]">
          We use industry-standard security measures to protect your personal
          information from unauthorized access, alteration, disclosure, or
          destruction. However, no data transmission over the internet or
          storage system can be guaranteed 100% secure. While we strive to
          protect your data, we cannot guarantee absolute security.
        </p>
      </div>
      <div className="mt-6">
        <h1 className=" text-2xl  font-semibold  mb-4">8. Third-Party Links</h1>
        <p className="text-[#686868]">
          Our platform may contain links to third-party websites or services
          that are not owned or controlled by Cleverank. We are not responsible
          for the privacy practices of these third-party sites. We encourage you
          to review their privacy policies before submitting any personal
          information.
        </p>
      </div>
      <div className="mt-6">
        ...
        <p className="text-[#686868]">
          ...
          under the age of 18. If we discover that we have collected personal
      ...
      <div className="mt-6">
        <h1 className=" text-2xl  font-semibold  mb-4">11. Contact Us</h1>
        <p className="text-[#686868]">
